...
const startButtonDiv = document.querySelector(".start-button-div");
...
selectorBtn.forEach((button) => {
   //All three button will be styled, share a class, and added to the
...
function computerPlay() {
   ...
   switch (
      choice //Evaluate the number stored in choice
   ) {
      case 1:
...
function playRound(playSelection, computerSelection) {
   ...
   switch (
      playerSelectionUpper //Evaluating the variable playerSelectionUpper
   ) {
      case "ROCK":
         if (computerSelection === "SCISSORS") {
            resultText.style.color = "#831568";
            ...
            resultText.style.color = "#33207a";
            resultString = "You Lose, Paper beats Rock";
            return "comp";
         } else if (computerSelection === "ROCK") {
            resultText.style.color = "#1A1919";
...
function showScores(uScore, cScore) {
   //Displays the scores of each player in the console
...
function fadeIn(element) {
   //gives 'element' the animation effect of fading into the webpage
...
function startGame() {
   ...
   mainDiv.removeChild(gameHeading);
   mainDiv.removeChild(introOne);
   mainDiv.removeChild(introTwo);
   mainDiv.removeChild(startButtonDiv);
   ...
   selectorBtn.forEach((button) => {
      ...
      button.addEventListener("click", () => {
         ...
         mainDiv.insertBefore(playsDiv, roundDiv);
         ...
         if (roundResults[2] === "user") {
            //the string stored in this array at index 2 tells the winner
         ...
         setTimeout(() => {
            ...
            mainDiv.removeChild(playsDiv); //removes the divs showing the plays of each player
